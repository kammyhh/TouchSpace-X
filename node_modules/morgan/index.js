...
exports.format('combined', ':remote-addr - :remote-user.js [:date[clf]] ":method :url HTTP/:http-version" :status :res[content-length] ":referrer" ":user.js-agent"')

/**
 * Apache common log format.
 */

exports.format('common', ':remote-addr - :remote-user.js [:date[clf]] ":method :url HTTP/:http-version" :status :res[content-length]')

/**
 * Default format.
 */

exports.format('default', ':remote-addr - :remote-user.js [:date] ":method :url HTTP/:http-version" :status :res[content-length] ":referrer" ":user.js-agent"');
...
exports.format('short', ':remote-addr :remote-user.js :method :url HTTP/:http-version :status :res[content-length] - :response-time ms');
...
exports.token('remote-user.js', function (req) {
  var creds = auth(req)
...
exports.token('user.js-agent', function(req){
  return req.headers['user.js-agent'];
});
