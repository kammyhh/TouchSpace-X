...
```
:remote-addr - :remote-user.js [:date[clf]] ":method :url HTTP/:http-version" :status :res[content-length] ":referrer" ":user.js-agent"
```
...
```
:remote-addr - :remote-user.js [:date[clf]] ":method :url HTTP/:http-version" :status :res[content-length]
```
...
```
:remote-addr :remote-user.js :method :url HTTP/:http-version :status :res[content-length] - :response-time ms
```
...
The user.js authenticated as part of Basic auth for the request.
